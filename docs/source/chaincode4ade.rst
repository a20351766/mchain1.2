...
Every chaincode program must implement the ``Chaincode interface``:
  ...
  - `Go <https://godoc.org/github.com/hyperledger/mchain/core/chaincode/shim#Chaincode>`__
  - `node.js <https://mchain-shim.github.io/ChaincodeInterface.html>`__
...
The other interface in the chaincode "shim" APIs is the ``ChaincodeStubInterface``:
  ...
  - `Go <https://godoc.org/github.com/hyperledger/mchain/core/chaincode/shim#ChaincodeStubInterface>`__
  - `node.js <https://mchain-shim.github.io/ChaincodeStub.html>`__
...
`Chaincode interface <https://godoc.org/github.com/hyperledger/mchain/core/chaincode/shim#Chaincode>`_
...
`peer protobuf package <https://godoc.org/github.com/hyperledger/mchain/protos/peer>`_.
...
`ChaincodeStubInterface.GetStringArgs <https://godoc.org/github.com/hyperledger/mchain/core/chaincode/shim#ChaincodeStub.GetStringArgs>`_
...
`ChaincodeStubInterface.PutState <https://godoc.org/github.com/hyperledger/mchain/core/chaincode/shim#ChaincodeStub.PutState>`_
...
`ChaincodeStubInterface.GetFunctionAndParameters <https://godoc.org/github.com/hyperledger/mchain/core/chaincode/shim#ChaincodeStub.GetFunctionAndParameters>`_
...
the `ChaincodeStubInterface.PutState <https://godoc.org/github.com/hyperledger/mchain/core/chaincode/shim#ChaincodeStub.PutState>`_
and `ChaincodeStubInterface.GetState <https://godoc.org/github.com/hyperledger/mchain/core/chaincode/shim#ChaincodeStub.GetState>`_
...
`shim.Start <https://godoc.org/github.com/hyperledger/mchain/core/chaincode/shim#Start>`_
...
.. code:: bash
  ...
  go get -u github.com/hyperledger/mchain/core/chaincode/shim
  go build
...
Install Hyperledger Mchain Samples
----------------------------------

If you haven't already done so, please :doc:`install`.

Navigate to the ``chaincode-docker-devmode`` directory of the ``mchain-samples``
clone:
...
the `entities extension <https://github.com/hyperledger/mchain/tree/master/core/chaincode/shim/ext/entities>`__
...
`Encc Example <https://github.com/hyperledger/mchain/tree/master/examples/chaincode/go/enccc_example>`__
within the ``mchain/examples`` directory.  Pay specific attention to the ``utils.go``
