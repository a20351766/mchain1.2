...
func TestQueriesPrivateData(t *testing.T) {
	...
	// see function RegisterSysCCs in file 'mchain/core/scc/register.go'. In absence of this lscc returns error while deploying a chaincode with collection configurations.
