...
func Test_DeploymentPayload(t *testing.T) {
	...
	spec := &pb.ChaincodeSpec{
		ChaincodeId: &pb.ChaincodeID{
			Path: "github.com/hyperledger/mchain/examples/chaincode/go/example02/cmd",
		},
	}
...
func TestGetDeploymentPayload(t *testing.T) {
	...
	var tests = []struct {
		...
		{gopath: defaultGopath, spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/hyperledger/mchain/examples/chaincode/go/map"}}, succ: true},
		{gopath: defaultGopath, spec: &pb.ChaincodeSpec{ChaincodeId: &pb.ChaincodeID{Name: "Test Chaincode", Path: "github.com/hyperledger/mchain/examples/bad/go/map"}}, succ: false},
...
func TestGenerateDockerBuild(t *testing.T) {
	...
	tests := []struct {
		...
		{gopath: defaultGopath, spec: spec{CCName: "map", Path: "github.com/hyperledger/mchain/examples/chaincode/go/map", SuccessExpected: true, RealGen: true}},
		{gopath: defaultGopath, spec: spec{CCName: "mapBadPath", Path: "github.com/hyperledger/mchain/examples/chaincode/go/map", File: "/src/github.com/hyperledger/mchain/examples/bad/path/to/map.go", Mode: 0100400, SuccessExpected: false}},
		{gopath: defaultGopath, spec: spec{CCName: "mapBadMode", Path: "github.com/hyperledger/mchain/examples/chaincode/go/map", File: "/src/github.com/hyperledger/mchain/examples/chaincode/go/map/map.go", Mode: 0100555, SuccessExpected: false}},
