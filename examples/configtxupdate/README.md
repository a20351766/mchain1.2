...
The recommended path to proceed with this example is to run the script located at `mchain/examples/configtxupdate/reconfigure_batchsize/script.sh` by invoking
