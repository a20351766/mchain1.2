...
::
    ...
    export TEST_PKGS="github.com/hyperledger/mchain/core/ledger/..."
    make unit-test
...
`here <https://github.com/hyperledger/mchain-sdk-node/blob/master/README.md>`__.
...
file <https://github.com/hyperledger/mchain/blob/master/devenv/setup.sh>`__
...
script <https://github.com/hyperledger/mchain/blob/master/devenv/setupRHELonZ.sh>`__
...
::
    ...
    source mchain/devenv/setupRHELonZ.sh
...
script <https://github.com/hyperledger/mchain/blob/master/devenv/setupUbuntuOnPPC64le.sh>`__
...
the following commands to build the mchain code:
...
::
    ...
    git clone http://gerrit.hyperledger.org/r/mchain
    sudo ./mchain/devenv/setupUbuntuOnPPC64le.sh
    cd $GOPATH/src/github.com/hyperledger/mchain
    make dist-clean all
...
::
   ...
   mkdir -p $GOPATH/src/github.com/hyperledger
   FABRIC=$GOPATH/src/github.hyperledger/mchain
   git clone https://github.com/hyperledger/mchain $FABRIC
   cd $FABRIC
