...
Contributions to the Hyperledger Mchain code base require a
...
1. Go to
   `Gerrit <https://gerrit.hyperledger.org/r/#/admin/projects/mchain>`__.
...
::
    ...
    git clone ssh://<LFID>@gerrit.hyperledger.org:29418/mchain mchain
